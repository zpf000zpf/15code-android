...
Android client for 15code. Version 1.2.0 is a native chat app that signs in with a 15code account, loads available models, and streams replies from the same 15code API platform used by the desktop app.
